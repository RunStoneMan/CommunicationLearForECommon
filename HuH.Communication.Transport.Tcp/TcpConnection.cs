...
using HuH.Communication.Transport.Tcp.Framing;
...
namespace HuH.Communication.Transport.Tcp
{
    public class TcpConnection : ITcpConnection
    {
        ...
        public TcpConnection(Socket socket, IByteBufferPool receiveDataBufferPool, Action<ITcpConnection, byte[]> messageArrivedHandler
        ...
        private void TrySend()
        {
            ...
            while (_sendingQueue.TryDequeue(out segments))
            {
                ...
                if (_sendingStream.Length >= TcpConfiguration.MaxSendPacketSize)
                {
                    break;
                }
            }
        ...
        private void TryReceive()
        {
            ...
            var buffer = _receiveDataBufferPool.Take();
            if (buffer == null)
            {
