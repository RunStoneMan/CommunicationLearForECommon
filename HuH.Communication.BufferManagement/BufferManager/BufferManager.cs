...
namespace HuH.Communication.BufferManagement.BufferManager
{
    public class BufferManager
    {
        ...
        private static readonly ILogger Log = ObjectContainer.Resolve<ILoggerFactory>().Create(typeof(BufferManager).FullName);
        ...
        private void CreateNewSegment(bool forceCreation)
        {
            ...
            lock (_creatingNewSegmentLock)
            {
                ...
                Log.Debug(String.Format("Segments count: {0}, buffers count: {1}, should be when full: {2}",
                                  _segments.Count,
                                  _buffers.Count,
